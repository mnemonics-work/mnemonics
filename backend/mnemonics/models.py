...
class Expression(models.Model):
    ...
    tags = models.ManyToManyField(Tag, related_name="expressions")
...
class Mnemonic(models.Model):
    ...
    expression = models.ForeignKey(
        Expression, null=True, on_delete=models.SET_NULL, related_name="mnemonics"
    )
...
class Category(models.Model):
    ...
    parent_topic = models.ForeignKey(
        "self", null=True, on_delete=models.SET_NULL, related_name="child_topics"
    )
